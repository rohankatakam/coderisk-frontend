      ...
      <div className="rounded-2xl p-8 border-2 border-slate-200">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-slate-50 rounded-xl p-5 border border-slate-200">
            <h4 className="font-bold text-[#0F172A] mb-2">Layer 1: Code Structure</h4>
          ...
          {/* Layer 2 */}
          <div className="bg-slate-50 rounded-xl p-5 border border-slate-200">
            <h4 className="font-bold text-[#0F172A] mb-2">Layer 2: Commit & PR History</h4>
            <p className="text-sm text-[#475569]">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-slate-50 rounded-xl p-5 border border-slate-200">
            <div className="flex items-center justify-between mb-2">
              <h4 className="font-bold text-[#0F172A]">1. Detect Changes</h4>
              <span className="text-xs font-semibold text-[#22C55E] bg-green-50 px-2 py-1 rounded border border-green-200">
                &lt;100ms
              </span>
            </div>
            <p className="text-sm text-[#475569]">
          ...
          <div className="bg-slate-50 rounded-xl p-5 border border-slate-200">
            <div className="flex items-center justify-between mb-2">
              <h4 className="font-bold text-[#0F172A]">2. Query Graph</h4>
              <span className="text-xs font-semibold text-[#22C55E] bg-green-50 px-2 py-1 rounded border border-green-200">
                &lt;200ms
              </span>
            </div>
          ...
          <div className="bg-orange-50 rounded-xl p-5 border-2 border-[#F97316] relative">
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#F97316] text-white px-4 py-1 rounded-full text-xs font-bold shadow-lg">
              THE SPECIAL SAUCE
            </div>
            <h4 className="font-bold text-[#0F172A] mb-3 mt-2">
              3. Agentic Search
            </h4>
            <div className="bg-white rounded-lg p-4 border border-orange-200">
              <p className="text-sm text-[#475569] mb-2 font-semibold">
          ...
          <div className="bg-green-50 rounded-xl p-5 border border-green-300">
            <h4 className="font-bold text-[#0F172A] mb-2">4. Risk Report</h4>
            <p className="text-sm text-[#475569] mb-2">
