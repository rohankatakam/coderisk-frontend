...
export default function IncidentTimelineAnimation() {
  ...
  const terminalLines = [
    ...
    { text: '', delay: 200, type: 'output' as const },
    { text: 'Found 3 past incidents in components/PaymentProcessor.tsx:', delay: 400, type: 'output' as const },
    ...
    { text: '', delay: 200, type: 'output' as const },
    { text: 'components/PaymentProcessor.tsx is coupled with:', delay: 400, type: 'output' as const },
