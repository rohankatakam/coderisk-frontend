        ...
        <section className="mb-16">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-green-500 pl-4">
              ...
              <p className="text-gray-600 text-sm">Full source code access with no black boxes</p>
            </div>
            <div className="border-l-4 border-blue-500 pl-4">
              <h3 className="font-semibold mb-1">Transparent</h3>
              <p className="text-gray-600 text-sm">Clear pricing and honest about requirements</p>
            </div>
            <div className="border-l-4 border-purple-500 pl-4">
              <h3 className="font-semibold mb-1">Sustainable</h3>
              <p className="text-gray-600 text-sm">Cloud revenue funds open source development</p>
            </div>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li className="flex items-start gap-2">
                  <div>
                    <strong>Submit pull requests</strong>
            ...
            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="font-semibold text-lg mb-4">Open for contributions:</h3>
              ...
              <h3 className="font-semibold text-lg mb-2 mt-6">Closed source:</h3>
